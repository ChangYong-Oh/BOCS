ising_src_dir = '/home/coh1/Experiments/CombinatorialBO/Ising_Others';
...
aero_src_dir = '/home/coh1/Experiments/CombinatorialBO/Aero_Others';
aero_dst_dir = '/home/coh1/Experiments/CombinatorialBO/Aero_Others_python_friendly_mat_files';
...
for i=1:numel(algorithms_in_my_naming)
    ...
    % lambda 0.0, 1e-4, 1e-2
    [data1, data2, data3] = summary_individual_files(model_name_in_my_naming, ising_src_dir);
    evaluation = data1;
    save([ising_dst_dir, '/', 'ising_', model_name_in_my_naming, '0E+00.mat'], 'evaluation');
    evaluation = data2;
    save([ising_dst_dir, '/', 'ising_', model_name_in_my_naming, '1E-04.mat'], 'evaluation');
...
for i=1:numel(algorithms_in_my_naming)
    model_name_in_my_naming = algorithms_in_my_naming{i};
    % lambda 0.0, 1e-4, 1e-2
    [~, ~, data3] = summary_individual_files(model_name_in_my_naming, aero_src_dir);
    evaluation = data3;
    save([aero_dst_dir, '/', 'aero_', model_name_in_my_naming, '1E-02.mat'], 'evaluation');
end